...
/*
* improve lighting quality by passing normals from vertex
...
void main () {
    ...
    out_Color = vec4(diffContrib + specContrib, diffColor.w);
}
)RAWSTR";
